...
# v3.4: 2-branch topology does not have audience tiers
if session.feature_yaml_context != null and session.feature_yaml_context.enabled == true:
  output: "ℹ️ This initiative uses 2-branch topology — audience promotion is not applicable. Use `/promote` for the plan→root PR model."
  exit: 0

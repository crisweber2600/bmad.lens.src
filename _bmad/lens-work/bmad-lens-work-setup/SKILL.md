...
```bash
python scripts/merge-config.py --module-yaml assets/module.yaml --target-config _bmad/_config/manifest.yaml
```
...
```bash
python scripts/merge-help-csv.py --module-csv assets/module-help.csv --target-csv _bmad/_config/bmad-help.csv
```
...
```bash
python scripts/cleanup-legacy.py --module-dir _bmad/lens-work
```
